...
class SignupScreen extends Component {
  ...
  login() {
    ...
    //   this.setState({
    //     isLoading: false,
    //     loginEmailValid: this.validateLoginEmail(loginEmail) || this.loginEmailInput.shake(),
    //     loginPasswordValid: loginPassword.length >= 8 || this.loginPasswordInput.shake(),
    //   });
    // }, 1500);
    LayoutAnimation.easeInEaseOut()
                ...
                <View style={{flexDirection: 'row' }}>
                  <TouchableOpacity
                    ...
                    style={{ backgroundColor: color.transparent, justifyContent:'center', height: 50, width: SCREEN_WIDTH/2, borderBottomWidth:2, 
                      ...
                      <Text style={{ fontFamily: font.QuicksandRegular, fontSize: 20, color: this.state.selectedCategory ? color.white : color.primary, textAlign: 'center', }}>
                        LOGIN </Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    ...
                    style={{ backgroundColor: color.transparent, justifyContent:'center', height: 50, width: SCREEN_WIDTH/2, borderBottomWidth:2, 
                      ...
                      <Text style={{ fontFamily: font.QuicksandRegular, fontSize: 20, color: this.state.selectedCategory ? color.primary : color.white, textAlign: 'center', }}>
                        SIGN UP </Text>
                  </TouchableOpacity>
                </View>
                  ...
                  <View style={{width: '85%', alignItems: 'center',}}>
                    ...
                    <TouchableOpacity
                      ...
                      style={{ backgroundColor: color.primary, justifyContent:'center', height: 50, width:'90%', borderRadius:30, marginVertical:20 }} >
                        <Text style={{ fontFamily: font.QuicksandRegular, fontSize: 15, color: color.white, textAlign: 'center', }}>
                          SIGN UP </Text>
                    </TouchableOpacity>

                    <Text style={{ fontSize:12, fontFamily: font.QuicksandRegular, color: color.black }}>
                ...
                <View style={{width: '85%', alignItems: 'center',}}>
                  ...
                  <View style={{ width: '85%', flexDirection:'row', justifyContent:'space-between', alignItems:'center', paddingHorizontal:10}} >
                    <View style={{ flexDirection: 'row', alignItems:'center' }}>
                      ...
                      />
                      <Text style={{ fontFamily: font.QuicksandRegular, fontSize: 12, color: color.placeholderColor, textAlign: 'center', }}>
                        Remember me </Text>
                    </View>
